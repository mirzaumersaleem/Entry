...
<form method="post" action="{{route('student.store')}}">
	...
	<div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3">
	  <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput">Participent ID</label>
	    <input type="text" name="student_id" class="form-control " id="formGroupExampleInput" placeholder="E.g.11122333" required>
		</div>
		
		{{-- <div class="form-group">
	    <label class="col-form-label" for="formGroupExampleInput">Participent Name</label>
	    <input type="text" name="student_name" class="form-control " id="formGroupExampleInput" placeholder="Type Your name" required>
	  </div> --}}
	  <div class="form-group">
